...
void SceneRunner::mouseMoveCallback(GLFWwindow* window, double xposIn, double yposIn)
{
...
void SceneRunner::keyCallback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
	auto sceneRunner = reinterpret_cast<SceneRunner*>(glfwGetWindowUserPointer(window));
